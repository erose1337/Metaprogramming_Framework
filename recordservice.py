...
class Record_Service(pride.authentication3.Authenticated_Service):
...
class Record_Service_Client(pride.authentication3.Authenticated_Client):
    ...
    @pride.authentication3.remote_procedure_call(callback_name="display_record")
