...
class Calendar(pride.gui.gui.Window):
    ...
    def change_month(self, month, year=None, day=None):
        ...
        # establish what weekday the 1st of the month is
        # find out how many unused days are on the row
        # fill in the unused days with the end of last month
        # fill in the remaining row with the first of this month
        ...
        assert year == 2018
        assert month_index == 8, month_index
        ...
        day_number = 0 # in case unused_days = 0 so offset = day_number won't raise an exception        
