...
if platform.system() == "Windows":
    import pride.dpapi
    os_encrypt = pride.dpapi.cryptData
    os_decrypt = pride.dpapi.decryptData
else:
...
class Encryption_Service(pride.base.Base):

    defaults = {"pride_file_type" : "pride.fileio.Database_File",
                "os_file_type" : "pride.fileio.File"}
